...
parser = argparse.ArgumentParser(description="Utility script to Monitor NVIDIA GPU and CPU usage",
                                 formatter_class=RawTextHelpFormatter)
parser.add_argument("-i", "--interval", help="the time interval in seconds to monitor (default 1)", type=int,
                    metavar='', default=int(1))
parser.add_argument("-mt", "--max_time",
                    help="the max time in minutes to run the program (default None(runs indefinetly))", metavar='',
                    default=None)
